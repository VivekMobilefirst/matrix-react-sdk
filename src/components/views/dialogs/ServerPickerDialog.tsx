...
> {
            ...
            if (!hsUrl.includes("://")) {
                try {
                    const discoveryResult =
                        await AutoDiscovery.findClientConfig(hsUrl);
                    this.validatedConf =
                        AutoDiscoveryUtils.buildValidatedConfigFromDiscovery(
                            hsUrl,
                            discoveryResult
                        );
                    ...
                    logger.error(
                        `Attempted ${hsUrl} as a server_name but it failed`,
                        e
                    );
                }
            }
    ...
    private onHomeserverValidate = (fieldState: IFieldState) =>
    ...
    private onSubmit = async (ev) => {
        ...
        this.props.onFinished(
            this.state.defaultChosen
                ? { ...this.defaultServer, isTorServer: this.state.isTorServer }
                : { ...this.validatedConf, isTorServer: this.state.isTorServer }
        );
    };
            ...
            >
                ...
                >
                    ...
                    >
                        <StyledCheckbox
                            name="isTorServer"
                            checked={this.state.isTorServer}
                            onChange={(e) => {
                                this.setState({
                                    isTorServer: e.target.checked,
                                });
                            }}
                        />
