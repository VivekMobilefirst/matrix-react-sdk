...
(function (WidgetMessagingStoreEvent) {
  ...
  WidgetMessagingStoreEvent["WidgetReady"] = "widget_ready";
...
class WidgetMessagingStore extends _AsyncStoreWithClient.AsyncStoreWithClient {
  ...
  // widgets that have sent a WidgetReady event
  constructor() {
    super(_dispatcher.default);
    (0, _defineProperty2.default)(this, "widgetMap", new _maps.EnhancedMap());
    (0, _defineProperty2.default)(this, "readyWidgets", new Set());
  }
  ...
  storeMessaging(widget, roomId, widgetApi) {
    ...
    widgetApi.once(`action:${_ElementWidgetActions.ElementWidgetActions.WidgetReady}`, ev => {
