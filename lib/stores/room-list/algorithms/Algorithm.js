...
var _VideoChannelStore = _interopRequireWildcard(require("../../VideoChannelStore"));
...
class Algorithm extends _events.EventEmitter {
  constructor() {
    ...
    (0, _defineProperty2.default)(this, "updateVideoRoom", () => {
  ...
  start() {
    _VideoChannelStore.default.instance.on(_VideoChannelStore.VideoChannelEvent.Connect, this.updateVideoRoom);

    _VideoChannelStore.default.instance.on(_VideoChannelStore.VideoChannelEvent.Disconnect, this.updateVideoRoom);
  }

  stop() {
    _VideoChannelStore.default.instance.off(_VideoChannelStore.VideoChannelEvent.Connect, this.updateVideoRoom);

    _VideoChannelStore.default.instance.off(_VideoChannelStore.VideoChannelEvent.Disconnect, this.updateVideoRoom);
  }
  ...
  doUpdateStickyRoom(val) {
    ...
    if (lastStickyRoom && lastStickyRoom.tag !== tag) this.recalculateVideoRoom(lastStickyRoom.tag); // Finally, trigger an update
  ...
  recalculateVideoRoom() {
    ...
    const videoRoomId = _VideoChannelStore.default.instance.connected ? _VideoChannelStore.default.instance.roomId : null;
